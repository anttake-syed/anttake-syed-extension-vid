...
import { DEV_SERVER_URL, PROD_SERVER_URL, DEV_WEB_UI_URL, PROD_WEB_UI_URL, IS_DEV } from '../shared/config.js';
...
export async function getConfig() {
  ...
  return {
    mode,
    serverUrl: IS_DEV ? DEV_SERVER_URL : PROD_SERVER_URL,
    webUiUrl:  IS_DEV ? DEV_WEB_UI_URL : PROD_WEB_UI_URL,
  };
}
